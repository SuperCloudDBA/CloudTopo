$(document).ready(function() {
            ...
            $.ajax({
                typt:"GET",
                url:"/static/js/json/20200828-53269aa6-0baf-44f6-9d7d-8c11ca0d267e.json",
                dataType:"json",
                        ...
                        if(a.elementType == "container"){
                           container = addContainer(a.text);
                               data.forEach(function(b){
                                   //此处可以加入地域节点
                                   if(b.level == 1 && b.elementType == "node" && b.instance_product == a.text){
                                        node_b = AddNode(b.x, b.y, b.instance_description, b.Image, b.textPosition, b.level, b.text);
                                        container.add(node_b);
                                        data.forEach(function(e){
                                            if(e.level == 2 && e.elementType == "node" && e.instance_id == b.instance_id){
                                            node_e = AddNode(e.x, e.y, e.db_name, e.Image, e.textPosition, e.level, e.text);
                                            container.add(node_e);
                                            Addlink(node_b, node_e, '', '');
                                            }
                                        });
                                   }
...
//                node.alarm = "instance_description";
