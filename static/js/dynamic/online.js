$(document).ready(function() {
            ...
            $.ajax({
                typt:"GET",
                url:"/static/js/json/online.json",
                dataType:"json",
                        ...
                        if(a.elementType == "container"){
                           container = addContainer(a.text);
                               data.forEach(function(b){
                                   //此处可以加入地域节点
                                    if(b.elementType == "node" && b.instance_product == a.text){
                                      node = AddNode(b.x, b.y, b.instance_description, b.Image, b.textPosition, b.level, b.text);
                                      container.add(node);
                                    }
                                });
                        }
